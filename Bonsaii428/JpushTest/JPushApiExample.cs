...
namespace JpushApiExample
{
    ...
    {
        public static String TITLE = "i am Panda - title";
        public static String ALERT = "u r maotiancai - alert ";
        ...
        static void Main(string[] args)
        {
            ...
            PushPayload payload = PushObject_ios_tagAnd_alertWithExtrasAndMessage();//选择一种方式
            try
            {
