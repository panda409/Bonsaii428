...
(function (factory) {
    ...
    var clndrTemplate =
        "<div class='clndr-controls'>" +
            ...
            "</div>" +
        "</div>" +
        "<table class='clndr-table' border='0' cellspacing='0' cellpadding='0' style='float:left'>" +
            "<thead>" +
            ...
            "<% for(var i = 0; i < numberOfRows; i++){ %>" +
                ...
                "<% var d = j + i * 7; %>" +
                    "<td class='<%= days[d].classes %>'>" +
                        ...
                        "<div class='day-contents' style='text-align:center' ><span id='day<%=days[d].day%>in_month'></span></div>" +
                    "</td>" +
                "<% } %>" +
                "</tr>" +
            "<% } %>" +
            "</tbody>" +
        "</table>"+
        "<div style='clear:both'><p id='today_work_state'></p></div>";
        ...
        if (!this.options.daysOfTheWeek) {
            ...
            for (var i = 0; i < 7; i++) {
                this.daysOfTheWeek.push(
                    moment().weekday(i).format('ddd'));//.charAt(0));
